...
*/
    ...
    private void updateUI(boolean isSignedIn,String userName,String userEmail,String userProfilePicUrl) {
        if (isSignedIn) {
            ...
            i.putExtra("user_profile_pic",userProfilePicUrl);
            startActivity(i);
        }/* else {
